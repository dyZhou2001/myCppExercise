//
// Created by zdy2001 on 2023/11/1.
//

#ifndef CHAPTER14MITEST_WORKERMI_H
#define CHAPTER14MITEST_WORKERMI_H
#include <string>
...
protected:
    enum {other,alto,contralto,soprano,bass,bariton,tensor};
    enum {Vtypes=7};
    virtual void Data()const;
    virtual void Get();
private:
...
#endif //CHAPTER14MITEST_WORKERMI_H
